...
- 2026-09-25: HTTP/Kafka W3C trace propagation is locally validated on work based
  on `71b94ff`: 108 Maven tests pass, including six real-JAR E2E scenarios with
